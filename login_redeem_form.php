...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <form class="container-fluid form-signin" action="add_user.php" method="post">
      ...
      <h1 class="h3 mb-3 font-weight-normal">BAT-redeem my card!</h1>

      <input type="text" class="form-control top" placeholder="Gift Card Number" name="cardCode" required>
      ...
      <button class="btn btn-lg btn-primary btn-block" id="submitButton" type="submit">BAT-reedem My Card!</button>
    ...
    <script src="js/login_redeem.js" charset="utf-8"></script>
