...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <form class="container-fluid form-signin" action="add_user.php" method="post">
      ...
      <h1 class="h3 mb-3 font-weight-normal">The one and onlyt Bat-giftcard!</h1>
      ...
      <button class="btn btn-lg btn-primary btn-block" id="submitButton" type="submit">Buy Bat-giftcard!</button>
